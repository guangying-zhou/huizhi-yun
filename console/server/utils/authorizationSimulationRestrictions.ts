...
const restrictedResourceRules: RestrictedResourceRule[] = [
  ...
  {
    resourceCode: 'data_runtime',
    actions: ['edit', 'deploy', 'admin'],
    reason: 'data-runtime configuration or remote deployment'
  },
  {
    resourceCode: 'runtime_apps',
    actions: ['admin'],
    reason: 'runtime application process control'
  },
  {
    resourceCode: 'authorization_lifecycle',
    actions: ['admin'],
    reason: 'authorization lifecycle retry can modify effective grants'
  },
  {
