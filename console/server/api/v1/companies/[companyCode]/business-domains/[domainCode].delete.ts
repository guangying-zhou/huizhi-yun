import { deleteConsoleBusinessDomain } from '@hzy/foundation/server/utils/consoleTenantRuntimeClient'
...
export default defineEventHandler(async (event) => {
  ...
  return await deleteConsoleBusinessDomain(event, domainCode, await readBody(event))
})
