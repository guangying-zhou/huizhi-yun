import { updateConsoleRegion } from '@hzy/foundation/server/utils/consoleTenantRuntimeClient'
...
export default defineEventHandler(async (event) => {
  ...
  return await updateConsoleRegion(event, regionCode, await readBody(event))
})
