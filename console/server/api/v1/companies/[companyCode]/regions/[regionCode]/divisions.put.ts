import { replaceConsoleRegionDivisions } from '@hzy/foundation/server/utils/consoleTenantRuntimeClient'
...
export default defineEventHandler(async (event) => {
  ...
  return await replaceConsoleRegionDivisions(event, regionCode, await readBody(event))
})
