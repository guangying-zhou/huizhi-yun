-- Console SQL Seed v1.40: repeatable, secret-free Altoc detail grant.
...
SELECT `id`,'altoc:notification-details','authorize',JSON_OBJECT('source','seed:v1.40','purpose','console-local-service-token-issuer'),'active',UTC_TIMESTAMP(),UTC_TIMESTAMP()
