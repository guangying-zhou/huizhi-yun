...
--   Aims/Codocs call Foundation semantic Git APIs; Tenant Runtime resolves the
--   credential and executes fixed GitLab operations without returning it.
--
-- Before applying:
...
SELECT
  ...
  JSON_OBJECT(
    'integrationCodes',
    JSON_ARRAY(@gitlab_integration_code),
    'operations',
    JSON_ARRAY(
      'gitlab.project-info',
      'gitlab.commits',
