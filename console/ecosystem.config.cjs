...
for (const key of ['DB_HOST', 'DB_PORT', 'DB_USER', 'DB_PASSWORD', 'DB_CONNECTION_LIMIT', 'DB_NAME', 'DB_SSL', 'DB_SSL_CA', 'DB_SSL_REJECT_UNAUTHORIZED', 'HZY_CONSOLE_VAULT_MASTER_KEY', 'CONSOLE_VAULT_MASTER_KEY', 'CONSOLE_AUTH_SIGNING_PRIVATE_JWK']) {
  delete fileEnv[key]
}
