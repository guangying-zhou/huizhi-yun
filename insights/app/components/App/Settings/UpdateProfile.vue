  ...
  <UCard>
    ...
    >
      <div class="col-span-full">
        <UFormField label="Avatar" size="lg" name="avatarUrl">
      ...
      <UFormField label="Email" size="lg" aria-readonly="true" readonly>
        <div
      ...
      <UFormField label="Account ID" size="lg" aria-readonly="true">
        <div
          class="cursor-not-allowed opacity-75 border-0 rounded-md text-sm px-3.5 py-2.5 shadow-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-700"
        >
          <span>{{ user.id }}</span>
      ...
      <UFormField label="Full name" size="lg" name="name">
