export type PermissionAction = 'view' | 'edit' | 'approve' | 'confirm' | 'cancel' | 'replay' | 'execute' | 'admin'
...
export const resources: ResourceDefinition[] = [
  ...
  { code: 'offboarding_tasks', name: '离职交接', description: '离职交接与资产回收协调任务', actions: ['view', 'edit', 'confirm', 'cancel', 'admin'], sortOrder: 25 },
  ...
  { code: 'documents', name: '文档引用', description: '员工、任职和绩效相关 Codocs 文档引用', actions: ['view', 'edit', 'admin'], sortOrder: 50 },
  ...
  { code: 'integration_operations', name: '跨应用操作', description: '诊断并受控重放 People 发起的 Directory 与 Assets 可靠操作', actions: ['view', 'replay'], sortOrder: 95 },
  { code: 'hr_source_sync', name: '人事事实源', description: '钉钉正式行政组织、人员主归属和在离职状态同步', actions: ['view', 'execute', 'admin'], sortOrder: 96 },
...
export const routeRules: RouteRule[] = [
  ...
  { pattern: '/assignments/**', resource: 'assignments', action: 'view' },
  { pattern: '/onboarding-cases', resource: 'employees', action: 'view' },
  { pattern: '/onboarding-cases/**', resource: 'employees', action: 'view' },
  { pattern: '/offboarding-cases', resource: 'offboarding_tasks', action: 'view' },
  { pattern: '/offboarding-cases/**', resource: 'offboarding_tasks', action: 'view' },
  ...
  { pattern: '/settings/ranks/**', resource: 'ranks', action: 'admin' },
  { pattern: '/settings/hr-source-sync', resource: 'hr_source_sync', action: 'view' },
  { pattern: '/settings/hr-source-sync/**', resource: 'hr_source_sync', action: 'view' },
  { pattern: '/settings/**', resource: 'admin', action: 'admin' }
]
