...
export interface Employee {
  ...
  onboard_date_source?: 'dingtalk' | 'oa_archive' | 'manual' | null
...
export type EmployeePrivateFactSource = 'dingtalk' | 'manual' | 'oa_archive'

export interface EmployeePrivateFactValue {
  value: string
  source?: EmployeePrivateFactSource | null
  editable: boolean
  has_value: boolean
...
export interface EmployeePrivateProfile {
  employee_uid: string
  fields: Record<'id_number' | 'birth_date' | 'education_level' | 'major' | 'graduation_school' | 'graduation_date', EmployeePrivateFactValue>
}
...
export interface ContributionSnapshot {
  ...
  contribution_score?: number | string | null
...
export type OffboardingTaskType = 'handover' | 'asset_recovery_coordination'
export type OffboardingTaskStatus = 'pending' | 'completed' | 'cancelled'
...
export interface OffboardingCaseList {
  items: OffboardingCaseDetail[]
