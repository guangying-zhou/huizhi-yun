...
INSERT INTO `people_contribution_snapshots` (
  `contribution_code`, `cycle_code`, `employee_uid`, `project_code`, `role_code`, `work_hours`, `contribution_score`, `score_status`, `source_app`, `source_biz_type`, `source_biz_id`, `source_refs`
)
VALUES
  ('CONTR-2026Q2-GZ-FIN', 'PC-2026Q2', 'g.zhao', 'PRJ-FIN', '研发', 60.00, 92.00, 'scored', 'aims', 'task', 'PRJ-FIN', JSON_OBJECT('tasks', JSON_ARRAY('TASK-1001', 'TASK-1002'))),
  ('CONTR-2026Q2-GZ-WF', 'PC-2026Q2', 'g.zhao', 'PRJ-WF', '研发', 48.00, 88.00, 'scored', 'aims', 'task', 'PRJ-WF', JSON_OBJECT('tasks', JSON_ARRAY('TASK-2001'))),
  ('CONTR-2026Q2-LX-FIN', 'PC-2026Q2', 'l.xiao', 'PRJ-FIN', '研发', 152.00, 88.00, 'scored', 'aims', 'worklog', 'PRJ-FIN', JSON_OBJECT('worklogs', JSON_ARRAY('WL-3001'))),
  ('CONTR-2026Q2-LX-CODOCS', 'PC-2026Q2', 'l.xiao', 'PRJ-CODOCS', '研发', 88.00, 80.00, 'scored', 'aims', 'task', 'PRJ-CODOCS', JSON_OBJECT('tasks', JSON_ARRAY('TASK-3001')))
ON DUPLICATE KEY UPDATE `work_hours` = VALUES(`work_hours`), `contribution_score` = VALUES(`contribution_score`), `score_status` = VALUES(`score_status`), `source_refs` = VALUES(`source_refs`);
