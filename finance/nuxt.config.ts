...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    hzy: {
      ...
      serviceClient: {
        clientId: process.env.HZY_FINANCE_SERVICE_CLIENT_ID || process.env.HZY_SERVICE_CLIENT_ID || '',
        clientSecret: process.env.HZY_FINANCE_SERVICE_CLIENT_SECRET || process.env.HZY_SERVICE_CLIENT_SECRET || '',
        tokenUrl: process.env.HZY_CONSOLE_TOKEN_URL || ''
      },
      notifications: {
        dueEnabled: process.env.HZY_FINANCE_DUE_NOTIFICATIONS_ENABLED || 'false'
      },
