...
const summaryCards = computed(() => [
  ...
  {
    label: '项目毛利',
    value: summary.value.projectGrossProfitAmount === null ? '待核算' : formatMoney(summary.value.projectGrossProfitAmount),
    hint: summary.value.projectGrossProfitAmount === null
      ? `${summary.value.projectCostNotReadyCount || '存在'} 个项目成本未就绪`
      : 'v0.3 项目核算',
