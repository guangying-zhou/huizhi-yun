...
const operations = {
  'console.directory-self-departments': { path: '/v1/enterprise/console/directory-self:departments', capability: 'console:directory-self:read' },
  'console.directory-self-projects': { path: '/v1/enterprise/console/directory-self:projects', capability: 'console:directory-self:read' },
  'codocs.collab-document-list': { path: '/v1/enterprise/codocs/collab-documents:list', capability: 'codocs:collab-documents:read' },
  'codocs.collab-document-list-admin': { path: '/v1/enterprise/codocs/collab-documents:list-admin', capability: 'codocs:collab-documents:review-admin' },
  'codocs.publish-execution-seal': { path: '/v1/enterprise/codocs/publish-execution:seal', capability: 'codocs:publish-execution:seal' },
  'codocs.publish-execution-send': { path: '/v1/enterprise/codocs/publish-execution:send', capability: 'codocs:publish-execution:send' },
  'codocs.publish-execution-receive': { path: '/v1/enterprise/codocs/publish-execution:receive', capability: 'codocs:publish-execution:receive' },
  'codocs.document-share-list': { path: '/v1/enterprise/codocs/document-shares:list', capability: 'codocs:document-shares:read' },
  'codocs.document-share-mark-read': { path: '/v1/enterprise/codocs/document-shares:mark-read', capability: 'codocs:document-shares:mark-read' },
  'codocs.document-share-create': { path: '/v1/enterprise/codocs/document-shares:create', capability: 'codocs:document-shares:create' },
  'codocs.document-share-update': { path: '/v1/enterprise/codocs/document-shares:update', capability: 'codocs:document-shares:edit' },
  'codocs.document-share-delete': { path: '/v1/enterprise/codocs/document-shares:delete', capability: 'codocs:document-shares:delete' },
  'codocs.review-history-by-document': { path: '/v1/enterprise/codocs/review-history:by-document', capability: 'codocs:review-history:read' },
  'codocs.review-history-by-oss-path': { path: '/v1/enterprise/codocs/review-history:by-oss-path', capability: 'codocs:review-history:read' },
  'codocs.review-history-company-by-oss-path': { path: '/v1/enterprise/codocs/review-history:company-by-oss-path', capability: 'codocs:review-history:company-read' },
  'codocs.document-annotations-list': { path: '/v1/enterprise/codocs/document-annotations:list', capability: 'codocs:document-annotations:read' },
  'codocs.document-annotations-create': { path: '/v1/enterprise/codocs/document-annotations:create', capability: 'codocs:document-annotations:create' },
  'codocs.document-annotations-update': { path: '/v1/enterprise/codocs/document-annotations:update', capability: 'codocs:document-annotations:edit' },
  'codocs.document-annotation-reply-create': { path: '/v1/enterprise/codocs/document-annotations:reply-create', capability: 'codocs:document-annotations:edit' },
  'codocs.document-annotation-reply-delete': { path: '/v1/enterprise/codocs/document-annotations:reply-delete', capability: 'codocs:document-annotations:edit' },
  'codocs.personal-cabinet-list': { path: '/v1/enterprise/codocs/personal-cabinet:list', capability: 'codocs:personal-cabinet:read' },
  'codocs.personal-cabinet-upload-plan': { path: '/v1/enterprise/codocs/personal-cabinet:upload-plan', capability: 'codocs:personal-cabinet:create' },
  'codocs.personal-cabinet-upload': { path: '/v1/enterprise/codocs/personal-cabinet:upload', capability: 'codocs:personal-cabinet:create' },
  'codocs.personal-cabinet-conversion-plan': { path: '/v1/enterprise/codocs/personal-cabinet:conversion-plan', capability: 'codocs:personal-cabinet:create' },
  'codocs.personal-cabinet-convert': { path: '/v1/enterprise/codocs/personal-cabinet:convert', capability: 'codocs:personal-cabinet:create' },
  'codocs.personal-cabinet-delete': { path: '/v1/enterprise/codocs/personal-cabinet:delete', capability: 'codocs:personal-cabinet:delete' },
  ...
  'codocs.personal-document-update': { path: '/v1/enterprise/codocs/personal-documents:update', capability: 'codocs:personal-documents:edit' },
  'codocs.personal-document-update-plan': { path: '/v1/enterprise/codocs/personal-documents:update-plan', capability: 'codocs:personal-documents:edit' },
  'codocs.document-transfer-department': { path: '/v1/enterprise/codocs/document-transfer:department', capability: 'codocs:document-transfer:department' },
  'codocs.document-transfer-project': { path: '/v1/enterprise/codocs/document-transfer:project', capability: 'codocs:document-transfer:project' },
  ...
  'codocs.personal-document-versions-list': { path: '/v1/enterprise/codocs/personal-documents:versions', capability: 'codocs:personal-documents:read' },
  'codocs.personal-document-version-view': { path: '/v1/enterprise/codocs/personal-documents:version-view', capability: 'codocs:personal-documents:read' },
  'codocs.personal-document-version-delete': { path: '/v1/enterprise/codocs/personal-documents:version-delete', capability: 'codocs:personal-documents:edit' },
  // v2 snapshots: registered in Runtime only when apps.codocs.snapshotV2Enabled.
  'codocs.personal-document-snapshot-prepare': { path: '/v1/enterprise/codocs/personal-documents:snapshot-prepare', capability: 'codocs:personal-documents:edit' },
  'codocs.personal-document-snapshot-publish': { path: '/v1/enterprise/codocs/personal-documents:snapshot-publish', capability: 'codocs:personal-documents:edit' },
  'codocs.personal-document-snapshot-read': { path: '/v1/enterprise/codocs/personal-documents:snapshot-read', capability: 'codocs:personal-documents:read' },
  // Stage B: registered in Runtime only with apps.codocs.collaborationV2Enabled.
  'codocs.personal-document-collaboration-open': { path: '/v1/enterprise/codocs/personal-documents:collaboration-open', capability: 'codocs:personal-documents:edit' },
  ...
  'assets.ip-assets-products': { path: '/v1/enterprise/assets/ip-assets:products', capability: 'assets:ip-asset:read' },
  ...
  'assets.ip-assets-link-product': { path: '/v1/enterprise/assets/ip-assets:link-product', capability: 'assets:ip-asset:link-product' },
  ...
  'aims.version-scope-list': { path: '/v1/enterprise/aims/product-version:scope-list', capability: 'aims:product-versions:read' },
  'aims.version-scope-history': { path: '/v1/enterprise/aims/product-version:scope-history', capability: 'aims:product-versions:read' },
  'aims.version-scope-deliver': { path: '/v1/enterprise/aims/product-version:scope-deliver', capability: 'aims:product-versions:scope-deliver' },
  'aims.version-scope-reopen': { path: '/v1/enterprise/aims/product-version:scope-reopen', capability: 'aims:product-versions:scope-reopen' },
  'aims.version-scope-edit': { path: '/v1/enterprise/aims/product-version:scope-edit', capability: 'aims:product-versions:scope-edit' },
  'aims.version-scope-visibility': { path: '/v1/enterprise/aims/product-version:scope-visibility', capability: 'aims:product-versions:scope-visibility' },
  'aims.version-scope-legacy-criteria': { path: '/v1/enterprise/aims/product-version:scope-legacy-criteria', capability: 'aims:product-versions:scope-legacy-criteria' },
  ...
  'aims.work-item-matter-complete': { path: '/v1/enterprise/aims/work-items:matter-complete', capability: 'aims:work-item-complete:execute' },
  'aims.work-item-plan-ready': { path: '/v1/enterprise/aims/work-items:plan-ready', capability: 'aims:work-item-plan-ready:execute' },
  ...
  'aims.product-document-list': { path: '/v1/enterprise/aims/product-documents:list', capability: 'aims:product-documents:read' },
  'aims.product-document-requests': { path: '/v1/enterprise/aims/product-documents:requests', capability: 'aims:product-documents:read' },
  'aims.product-document-search': { path: '/v1/enterprise/aims/product-documents:search', capability: 'aims:product-documents:read' },
  'aims.product-document-content': { path: '/v1/enterprise/aims/product-documents:content', capability: 'aims:product-documents:read' },
  'aims.product-document-link': { path: '/v1/enterprise/aims/product-documents:link', capability: 'aims:product-documents:create' },
  'aims.project-products-list': { path: '/v1/enterprise/aims/project-products:list', capability: 'aims:project-products:read' },
  'aims.project-products-link': { path: '/v1/enterprise/aims/project-products:link', capability: 'aims:project-products:create' },
