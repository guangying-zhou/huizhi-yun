...
const tenantRuntimeProfiles = new Set<string>([
  'managed-cloud-agent',
  'managed-cloud-runtime'
])
...
export function isTenantRuntimeProfile(profile = resolveDeploymentProfile()) {
  return tenantRuntimeProfiles.has(profile)
}
