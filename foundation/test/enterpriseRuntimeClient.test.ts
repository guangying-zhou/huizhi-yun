...
for (const [operation, path, capability] of [
  ['codocs.personal-document-update-plan', '/v1/enterprise/codocs/personal-documents:update-plan', 'codocs:personal-documents:edit'],
  ['codocs.personal-document-update', '/v1/enterprise/codocs/personal-documents:update', 'codocs:personal-documents:edit'],
  ...
  ['assets.ip-assets-products', '/v1/enterprise/assets/ip-assets:products', 'assets:ip-asset:read'],
  ...
  ['assets.ip-assets-link-product', '/v1/enterprise/assets/ip-assets:link-product', 'assets:ip-asset:link-product'],
  ...
  ['aims.version-scope-list', '/v1/enterprise/aims/product-version:scope-list', 'aims:product-versions:read'],
  ['aims.version-scope-history', '/v1/enterprise/aims/product-version:scope-history', 'aims:product-versions:read'],
  ['aims.version-scope-edit', '/v1/enterprise/aims/product-version:scope-edit', 'aims:product-versions:scope-edit'],
  ['aims.version-scope-visibility', '/v1/enterprise/aims/product-version:scope-visibility', 'aims:product-versions:scope-visibility'],
  ['aims.version-scope-legacy-criteria', '/v1/enterprise/aims/product-version:scope-legacy-criteria', 'aims:product-versions:scope-legacy-criteria'],
  ...
  ['aims.work-item-matter-complete', '/v1/enterprise/aims/work-items:matter-complete', 'aims:work-item-complete:execute'],
  ...
  ['aims.product-document-list', '/v1/enterprise/aims/product-documents:list', 'aims:product-documents:read'],
  ['aims.product-document-requests', '/v1/enterprise/aims/product-documents:requests', 'aims:product-documents:read'],
  ['aims.product-document-search', '/v1/enterprise/aims/product-documents:search', 'aims:product-documents:read'],
  ['aims.product-document-content', '/v1/enterprise/aims/product-documents:content', 'aims:product-documents:read'],
