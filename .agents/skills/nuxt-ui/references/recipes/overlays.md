...
Project application: these are general Nuxt UI API examples. In Foundation-enabled 汇智云 modules, destructive confirmations use the existing `useConfirm()` wrapper under root CLAUDE.md; do not copy the custom confirmation components below into business modules.
