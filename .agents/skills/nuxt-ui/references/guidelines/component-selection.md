...
### Rules
- In Foundation-enabled 汇智云 modules, use `useConfirm()` for destructive confirmations. `UModal` is the underlying general-purpose surface, not a reason to create a duplicate confirmation wrapper.
