...
const CASES = [
  {
    label: 'strict requires live URLs, Platform DB check, public routing, PM2 live and server Nginx configs',
    args: ['--strict'],
    expected: [
  ...
  {
    label: 'strict rejects retired Console DB verification options',
    fixture: 'cloudflare',
    args: [
      '--strict',
      '--console-prod-cloudflare',
  ...
  {
    label: 'strict rejects public routing and legacy Console DB shortcuts',
    fixture: 'pm2',
    args: [
      '--strict',
      '--public-routing',
