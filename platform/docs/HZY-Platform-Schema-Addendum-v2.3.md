...
状态：Draft v2.3
日期：2026-04-24
基线：`platform/docs/sql/HZY-Platform-SQL-DDL-Draft-v2.sql` + `Schema-Addendum-v2.1.md` + `Migration-v2.2.sql`
...
1. 更新 `platform/docs/sql/HZY-Platform-SQL-DDL-Draft-v2.sql` 主线，把 v2.3 变更并入（类似 v2.1 并入的方式）
