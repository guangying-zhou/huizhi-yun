  ...
  try {
    const response = await platformFetchJson<{
      ...
      body: {
        ...
        releaseTagPrefix: form.releaseTagPrefix || undefined,
      ...
      <div class="col gap-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <UFormField label="Git ref">
            <UInput
              v-model="form.ref"
              placeholder="默认由 Tag 前缀 + Release 版本生成"
              class="w-full"
              :ui="{ base: 'font-mono' }"
            />
          </UFormField>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <UFormField
            ...
            description="Monorepo 应用填写 aims/、codocs/ 等；旧独立仓留空。"
          >
            <UInput
