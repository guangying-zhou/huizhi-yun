...
function resetForm() {
  ...
  form.manifestPath = app.value.manifestPath || 'app.manifest.json'
  form.releaseTagPrefix = app.value.releaseTagPrefix || ''
}
  ...
  >
    ...
    <UCard>
      ...
      <div class="col gap-3.5">
        ...
        <UFormField
          label="GitLab 仓库"
          help="独立仓和 monorepo 都填写完整仓库 URL。"
        >
          <UInput
        ...
        <UFormField
          label="Manifest 路径"
          help="仓库内的相对路径；monorepo 例如 codocs/app.manifest.json。"
        >
          <UInput
        ...
        <UFormField
          label="Release Tag 前缀"
          help="独立仓留空；monorepo 例如 codocs/，仅显示该应用的 Tag。"
        >
          <UInput
