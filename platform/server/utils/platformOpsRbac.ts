...
import { candidateActionsForRequiredAction } from './permissionActions'
...
const OPS_SUPER_ADMIN_ACTIONS_BY_RESOURCE: Record<string, string[]> = {
  'ops.applications': ['view', 'edit', 'admin', 'release'],
...
function buildActionCandidates(requiredAction: string): string[] {
  return candidateActionsForRequiredAction(requiredAction, OPS_KNOWN_ACTIONS)
}
