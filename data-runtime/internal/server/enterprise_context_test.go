...
func enterpriseContextFixture(t *testing.T, mutate func(jwt.MapClaims), registered bool) (*auth.Authenticator, *http.Request, enterpriseRouteContext) {
	...
	route := enterpriseRouteContext{Binding: enterprise.BindingKey{Tenant: "tenant-a", Environment: "test", RuntimeDeployment: "runtime-test"}, HostDeployment: "enterprise-test", LogicalSource: "aims", LogicalTarget: "assets", Action: "read", Capability: "assets:product:read"}
