...
func TestEnterpriseProjectMembersMySQL(t *testing.T) {
	...
	t.Run("project product link preserves manager scope and receipt", func(t *testing.T) {
		exec(db, "INSERT INTO aims_projects(id,project_code,name,short_name,leader_uid,created_by,category,lifecycle_status) VALUES(920,'LINK-P','LinkProject','LP','U1','U1','product_dev','active'),(921,'LINK-R','Routine','LR','U1','U1','routine','active'),(922,'LINK-A','Archived','LA','U1','U1','product_dev','archived')")
		exec(db, "INSERT INTO aims_project_members(project_id,uid,role,status) VALUES(920,'U1','manager','active'),(921,'U1','manager','active'),(922,'U1','manager','active')")
		...
		first, err := a.LinkEnterpriseProjectProduct(ctx, id, "920", "PROD-LINK", permit)
		if err != nil {
			t.Fatal(err)
		}
		replay, err := a.LinkEnterpriseProjectProduct(ctx, id, "920", "PROD-LINK", permit)
