...
func (a *Adapter) createLead(ctx context.Context, body map[string]any) (map[string]any, error) {
	...
	auditID, err := insertAltocNotificationAuditTx(ctx, tx, "lead", leadID, "create", nil, map[string]any{
		"code":            code,
		"name":            fields["name"],
...
func (a *Adapter) assignLead(ctx context.Context, identifier string, body map[string]any) (map[string]any, error) {
	...
	auditID, err := insertAltocNotificationAuditTx(ctx, tx, "lead", leadID, "update", map[string]any{
