...
func mysqlConfig(cfg config.DBConfig) *mysql.Config {
	...
	// Runtime repositories scan DATETIME/TIMESTAMP columns into time.Time.
	// This connection invariant must not be caller-disableable.
