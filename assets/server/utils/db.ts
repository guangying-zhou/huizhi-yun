...
export type RowDataPacket = Record<string, string | number | null | undefined>
...
function directDbDisabled(): never {
  throw createError({
    statusCode: 500,
    message: 'Assets direct DB access is disabled. Route database operations through tenant-runtime/data-runtime.'
  })
}

export function useDbPool(): never {
