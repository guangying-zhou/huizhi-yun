...
export function getDashboardOverview() {
  return {
    ...
    quick_links: [
      { label: '实物资产', description: '查看办公设备、家具设施、IT基础设施等台账', to: '/physical', icon: 'i-lucide-laptop' },
      { label: '资源资产', description: '查看云资源、Seat、额度、证书', to: '/resources', icon: 'i-lucide-cloud-cog' },
