  ...
  <UDashboardGroup unit="rem">
    <LayoutSidebar>
      ...
      <template #navbar-left>
        <div id="assets-layout-header-title" class="flex min-w-0 flex-1 items-center gap-2 px-2 sm:px-4" />
      </template>

      <!-- 页面级头部操作按钮挂载点：各页面通过 Teleport 注入 -->
      <template #navbar-right>
        <div id="assets-layout-header-actions" class="flex items-center gap-2" />
      </template>
