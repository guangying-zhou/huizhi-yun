...
usePageTitle(computed(() => product.value?.product_name || '产品详情'))
...
const versionItems = computed(() => versionResponse.value?.data?.items || [])
          ...
          <template #header>
            <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div class="flex min-w-0 items-center gap-2">
                <span class="truncate font-semibold">{{ product.product_code }}</span>
