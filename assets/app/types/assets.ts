...
export interface CustomerDeliveryAssetItem {
  id: number
  delivery_asset_code: string
  customer_code: string
  contract_code?: string | null
  contract_line_code?: string | null
  project_code?: string | null
  delivery_view_code?: string | null
  ...
  support_expiry_at?: string | null
  responsible_uid?: string | null
  responsible_dept_code?: string | null
  updated_at?: string | null
}

export interface OffboardingRecoveryAssetItem {
  id: number
  public_id?: string | null
  asset_code: string
  asset_name: string
...
export interface OffboardingRecoveryCaseItem {
  id: number
  case_code: string
  source_app: string
  source_event_key: string
  departed_employee_uid: string
  departed_employee_name?: string | null
  offboarded_at: string
  recovery_due_at: string
  recovery_responsible_uid?: string | null
  ...
  items?: OffboardingRecoveryAssetItem[]
}
