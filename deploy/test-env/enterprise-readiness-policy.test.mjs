...
test('derives exact Runtime and independent external policies from checked-in contracts', () => {
  ...
  try {
    ...
    assert.deepEqual(policy.servicePolicy, {
      clientCode: 'enterprise.runtime', appCode: 'enterprise', capabilities: ['aims:projects:view', 'assets:product:read', 'credential_vault:resolve', 'integration_config:view'], audiences: ['data-runtime']
    })
