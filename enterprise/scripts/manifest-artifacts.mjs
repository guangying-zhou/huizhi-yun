...
export const releaseSourcePaths = ['enterprise', 'aims', 'assets', 'altoc', 'foundation', 'platform/packages', 'data-runtime']
export const releaseBuildFiles = ['package.json', 'pnpm-lock.yaml', 'pnpm-workspace.yaml']
...
export function composeManifest(manifests) {
  ...
  if (!apps.has('aims') || !apps.has('assets')) throw Error('Aims and Assets manifests are required')
  const catalog = {
