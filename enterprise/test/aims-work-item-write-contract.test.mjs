...
assert.match(bff,/action==='delete'\?'delete'/);assert.match(bff,/'complete','delete','start','reset','reopen','confirm-distribute','revoke-distribute','confirm-append','reject-append'\]\.includes\(action\)\)\?new Set\(\['expectedVersion'\]\)/)
