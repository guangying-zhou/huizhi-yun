...
export const globalMenuItems = [
  ...
  { label: '产品中心', icon: 'i-lucide-package-search', to: '/products' },
  { label: '项目日历', icon: 'i-lucide-calendar-days', to: '/timesheet' },
  { label: '项目文档', icon: 'i-lucide-files', to: '/project-documents' },
  { label: '质量检查', icon: 'i-lucide-shield-check', to: '/quality-reviews' },
  {
    label: '统计分析',
...
export const globalUtilityItems = [
  {
    ...
    children: [
      ...
      { label: '跨应用操作', icon: 'i-lucide-activity', to: '/integration-operations' }
    ]
  },
  {
    label: '使用指南',
