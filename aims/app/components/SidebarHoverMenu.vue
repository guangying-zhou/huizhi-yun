 ...
 * 通过 appCode 自动从 Account 获取应用名和 logo。
 *
 * Props:
 *  - show: 是否显示
 *  - links: 菜单分组数组
 *  - appCode: 应用编码（自动获取名称和 logo）
 */
...
const logoUrl = computed(() => appInfo.value?.icon || '/logo.png')
</script>
        ...
        <div class="sidebar-hover-panel">
          ...
          <div class="flex items-center gap-2 px-3 py-2 border-b border-default">
            <NuxtLink to="/" class="flex items-center gap-2">
              <img :src="logoUrl" class="h-5 w-auto" :alt="displayName">
