...
> 2026-09-07 后续方案：见 [AIMS 产品中心设计与落地计划](Aims-Product-Center-Implementation-Plan.md)。当前代码已增加管理员产品维度版本页，本文早期“无全局入口”范围描述不再代表完整现状。后续方案中的产品需求、长期功能、产品权限与发布快照仍待实施；本文的历史实施状态不等于当前线上验收状态。
