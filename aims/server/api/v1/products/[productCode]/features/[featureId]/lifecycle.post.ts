...
import { productFeatureLifecycleInput } from '../../../../../../utils/productFeatureLifecycleInput'
...
export default defineEventHandler(async (event) => {
  ...
  const runtime = await maybeCallTenantRuntime<{ code: number, data: unknown }>(event, `/v1/aims/internal/products/${encodeURIComponent(code)}/features:lifecycle`, {
