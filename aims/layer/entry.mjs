...
const navigation = Object.freeze([
  { area: 'product', group: 'planning', label: '产品管理空间', to: '/aims/products', order: 1 },
  { area: 'delivery', group: 'project', label: '项目总览', to: '/aims/projects', order: 1 },
  { area: 'delivery', group: 'execution', label: '任务中心', to: '/aims/work-items', order: 1 },
  { area: 'delivery', group: 'execution', label: '工时日历', to: '/aims/timesheet', order: 2 },
  { area: 'delivery', group: 'execution', label: '周报汇总', to: '/aims/weekly-reports', order: 3 }
])
...
const objectWorkspaces = Object.freeze([
  {
    ...
    backLabel: '返回项目总览',
    groups: [
      { label: '概览', items: [{ label: '项目概览', path: '' }] },
      { label: '计划与执行', items: [{ label: '里程碑', path: '/plan' }, { label: '任务看板', path: '/board' }] },
      { label: '交付与质量', items: [{ label: '需求', path: '/requirements' }, { label: '项目文档', path: '/documents' }] },
      { label: '团队与投入', items: [{ label: '项目成员', path: '/members' }, { label: '工时', path: '/timesheet' }, { label: '周报', path: '/weekly-reports' }] },
      { label: '项目管理', items: [{ label: '项目设置', path: '/edit' }] }
    ]
  }
])
