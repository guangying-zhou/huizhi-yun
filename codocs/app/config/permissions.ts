...
export const resources = [
  ...
  },
  {
    ...
    actions: ['view', 'create', 'edit', 'publish', 'export', 'admin'] satisfies PermissionAction[],
    sortOrder: 5
  },
  {
    code: 'reviews',
  ...
  },
  {
    code: 'help',
    name: '使用指南',
    description: 'Markdown 教程、Mermaid 语法',
    actions: ['view'] satisfies PermissionAction[],
    sortOrder: 8
  }
]
...
export const menus: MenuItem[][] = [
  [
    ...
    },
    {
      ...
      type: 'trigger',
      children: [
        { label: '公司制度', icon: 'i-lucide-landmark', to: '/company/rules', resource: 'company' },
        {
          label: '通知公告',
        ...
        { label: '法务合规', icon: 'i-lucide-scale', to: '/company/legal', resource: 'company' },
        { label: '企业文化', icon: 'i-lucide-heart', to: '/company/culture', resource: 'company' },
        { label: '技术规范', icon: 'i-lucide-code', to: '/company/tech-specs', resource: 'company' },
        { label: '产品资料', icon: 'i-lucide-package', to: '/products', resource: 'company' },
        {
          label: '公司知识库',
        ...
        },
        {
          ...
          to: '/company/open-department-docs'
        },
        {
          label: '文档模板',
...
const permissionExemptRoutes = new Set([
  '/company/open-department-docs'
])
...
export function matchRouteRule(path: string): RouteRule | null {
  if (permissionExemptRoutes.has(path)) return null
