...
interface PreviewResponse {
  ...
  data: {
    previewable: boolean
    preview_type?: 'direct' | 'office' | 'pptx' | 'text'
    preview_url?: string
    content?: string
    encoding?: string
    truncated?: boolean
          ...
          <div v-else class="max-w-5xl mx-auto w-full h-full relative">
            ...
            >
              ...
              <div
                ...
                class="w-full h-[calc(100vh-118px)] overflow-auto rounded-b-lg bg-elevated"
              >
                <div
                ...
                <pre class="m-0 whitespace-pre-wrap break-words p-4 font-mono text-sm leading-6 text-highlighted">{{ previewData.content }}</pre>
              </div>
