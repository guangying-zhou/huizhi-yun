...
const createEditorMermaidConfig = (isDark: boolean): MermaidConfig => {
...
let editorMermaidConfig = createEditorMermaidConfig(false)

export const initEditorMermaid = (isDark: boolean) => {
  editorMermaidConfig = createEditorMermaidConfig(isDark)
}
        ...
        void (async () => {
          ...
          enqueueRender(async () => {
            ...
            try {
              ...
              const { svg, bindFunctions } = await renderMermaid(editorMermaidConfig, svgId, content)
