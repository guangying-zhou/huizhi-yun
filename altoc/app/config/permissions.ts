...
export const resources: PermissionResource[] = [
  ...
  {
    code: 'integration_operations',
    name: '跨应用操作',
    description: '诊断并受控重放经营模块发起的跨应用可靠操作',
    actions: ['view', 'replay'],
    sortOrder: 95
  },
  {
...
export const menus: MenuItem[][] = [[
...
], [
  {
    ...
    to: '/admin/integration-operations',
...
export const routeRules: RouteRule[] = [
  { pattern: '/admin/integration-operations', resource: 'integration_operations', action: 'view' },
