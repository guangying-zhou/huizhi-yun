...
import { DECISION_ROLE_OPTIONS, OPPORTUNITY_STATUS_OPTIONS } from '~/types/altoc'
...
usePageTitle(computed(() => customer.value?.name || '客户详情'))
                  ...
                  <tbody class="divide-y divide-default">
                    <tr v-for="(ticket, index) in serviceTickets" :key="rowKey(ticket, `ticket-${index}`)">
                      ...
                      <td class="py-2 text-right">
                        ...
                        />
                        <ServiceTicketProductFeedback v-if="ticket.ticket_type === 'requirement' && ticket.code" :ticket-code="String(ticket.code)" />
                      </td>
                    </tr>
                  </tbody>
                </table>
