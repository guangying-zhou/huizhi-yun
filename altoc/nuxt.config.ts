...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    hzy: {
      ...
      productFeedback: {
        aimsDeployment: process.env.HZY_ALTOC_PRODUCT_FEEDBACK_AIMS_DEPLOYMENT || ''
      },
      tenantRuntime: {
      ...
      serviceClient: {
        clientId: process.env.HZY_ALTOC_SERVICE_CLIENT_ID || process.env.HZY_SERVICE_CLIENT_ID || '',
        clientSecret: process.env.HZY_ALTOC_SERVICE_CLIENT_SECRET || process.env.HZY_SERVICE_CLIENT_SECRET || '',
        tokenUrl: process.env.HZY_CONSOLE_TOKEN_URL || ''
      },
      notifications: {
        receivableDueEnabled: process.env.HZY_ALTOC_RECEIVABLE_DUE_NOTIFICATIONS_ENABLED || 'false'
      }
    },
