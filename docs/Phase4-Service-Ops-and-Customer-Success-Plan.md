...
> 状态：Phase 4 设计与实现参考（真实环境验收与生产发布待执行）
> 最后核对：2026-07-11
> 当前事实源：`docs/P3-P4-Release-Readiness-and-E2E-Acceptance.md`、`docs/release/P3-P4-2026-07.release.json`、`docs/MODULE_CONTRACTS.md`、Altoc/Aims/Assets/Codocs/Finance 当前 API/schema 与 data-runtime adapter
> 边界：下文“已完成”记录不等同于 migration、Cloudflare 发布、live probe、真实租户验收或生产发布；这些操作必须在批准窗口独立执行并留档。
