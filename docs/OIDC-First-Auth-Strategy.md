...
日期：2026-04-29  
定位：认证协议策略 ADR，作为 `Huizhi-yun-Platform-Target-Architecture.md`、`Identity-Plane-Design.md` 与 `console/docs/Console-Auth-Runtime-IdP-Implementation-Plan.md` 的补充说明
