...
原决策日期：2026-09-13。原稿仓库基线：`801b402e`。修订日期：2026-09-15。修订版本：1.1。

修订依据：用户提供的 ADR-017/018 与本轮讨论；本次不是最新代码或生产环境审计。保留原有业务整合、Nuxt Layers、租户业务单库与全量功能决策，补齐身份、查询、事务、任务、迁移和前端职责契约。
...
| Codocs、Workflow、Collab、通知及 Connector | 首轮保留现有运行边界；全量功能授权包含适用功能，不因独立部署另设购买门槛 |
