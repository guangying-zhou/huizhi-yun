...
- `console/docs/Console-Unified-Employee-Portal-Plan.md`
...
默认集成方式是“独立应用 + 统一身份 + 统一入口 + 统一导航”，不是 iframe 聚合，也不是把业务应用合并成单体。详细方案见 `console/docs/Console-Unified-Employee-Portal-Plan.md`。
