...
const navigation = Object.freeze([
  { area: 'product', group: 'catalog', label: '全部产品', to: '/assets/products', order: 1 },
  { area: 'product', group: 'assets', label: '知识产权', to: '/assets/ip-assets', order: 2 },
  { area: 'product', group: 'assets', label: '数字资产', to: '/assets/digital-assets', order: 3 },
  { area: 'operations', group: 'resource', label: '自用资产', to: '/assets/physical', order: 1 },
  { area: 'operations', group: 'resource', label: '资源台账', to: '/assets/resources', order: 2 },
  { area: 'console', group: 'config', label: '产品字典', to: '/assets/admin/asset-categories', order: 1 },
  { area: 'console', group: 'config', label: '资产字典', to: '/assets/admin/dictionaries', order: 2 }
])
