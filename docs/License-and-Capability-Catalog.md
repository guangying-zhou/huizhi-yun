...
状态：Draft  
日期：2026-04-21  
定位：目标设计，作为 `Huizhi-yun-Platform-Target-Architecture.md`、`Identity-Plane-Design.md`、`Control-Plane-API-Contract.md` 与 `foundation/docs/Foundation-SDK-Contract.md` 的配套文档
